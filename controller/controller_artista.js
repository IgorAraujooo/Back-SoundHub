    ...
    try {
        if (String(contentType).toLowerCase() === 'application/json') {
            if (
                ...
                dadosArtista.data_nascimento == '' || dadosArtista.data_nascimento == undefined || dadosArtista.data_nascimento.length > 10 ||
                dadosArtista.foto_artista == '' || dadosArtista.foto_artista == undefined || dadosArtista.foto_artista.length > 255
            ) {
