...
const insertArtist = async function(dadosArtista) {
    try {
        let sql = `
        ...
        let result = await prisma.$executeRawUnsafe(sql, dadosArtista.nome, dadosArtista.data_nascimento, dadosArtista.foto_artista);
